...
(function ($) {
	...
	//array to store the length of heights 
	sumSize=0;
	sumSizes=new Array(data.length);
	...
	function appendRowHtml(stringArray, row, range) {
		...
		//console.log("top is "+offset+" row is "+row+" idx "+d.num );
		//console.log(sumSizes);
		stringArray.push("<div class='ui-widget-content " + rowCss + "' style='top:" + (t) + "px'>");
	    }
	    else
...
//		if(!sumSizes[d.num]){
			...
			sumSizes[d.num]=t+offset;
//		}
		stringArray.push("<div class='" + cellCss + "' style='white-space:normal;height:"+h+"px;'>");
	    }
	    else{
	...
	function getVisibleRange(viewportTop, viewportLeft) {
		...
		for(var i=0;i<len;i++){
		    var cmp;
		    cmp=sumSizes[data.getItem(i).num];
	...
	function handleScroll() {
	    ...
	    //console.log("Vertical "+vScrollDist+" horizontal "+hScrollDist);
