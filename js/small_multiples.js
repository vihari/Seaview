...
getSrc = function(key){
    src = "http://localhost:8080/Seaview/small_plot.html?selectorID="+key+"&selector="+Selector+"&x=lineNum&width="+width+"&height="+height;
    return src;
}
